...
for v in range(n):
    for u in range(v + 1, n):
        current = len(adj[v]) + len(adj[u]) - (v in adj[u] or u in adj[v])
        max_rank = max(current, max_rank)
